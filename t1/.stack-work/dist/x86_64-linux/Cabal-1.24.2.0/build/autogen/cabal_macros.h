...
/* package t1-0.1.0.0 */
#define VERSION_t1 "0.1.0.0"
#define MIN_VERSION_t1(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "t1-0.1.0.0-GSi76OeccIvATMtrZIhwya"

#define CURRENT_PACKAGE_KEY "t1-0.1.0.0-GSi76OeccIvATMtrZIhwya"
